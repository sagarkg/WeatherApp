...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.ganatragmail.sagar.weatherapp";
    ...
    public static final class LocationEntry implements BaseColumns{
        ...
        public static final String ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_LOCATION;
    ...
    public static final class WeatherEntry implements BaseColumns{
        ...
        public static String getLocationSetting(Uri uri){
